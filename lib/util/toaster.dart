...
class Toaster {
  ...
  static void show(String msg, BuildContext context,
      ...
      Border? border}) {
    ToasterView.dismiss();
    ToasterView.createView(msg, context, duration, gravity, backgroundColor,
        textStyle, backgroundRadius, border, rootNavigator);
  }
}

class ToasterView {
  static final ToasterView _singleton = ToasterView._internal();

  factory ToasterView() {
    return _singleton;
  }

  ToasterView._internal();
  ...
  static void createView(
    ...
    await Future.delayed(Duration(seconds: duration ?? Toaster.lengthShort));
    dismiss();
  }
